...
from .synchrotron_question.views import router as puzzle_synchrotron_question_router
...
router.include_router(puzzle_synchrotron_question_router, prefix="/synchrotron_question")
